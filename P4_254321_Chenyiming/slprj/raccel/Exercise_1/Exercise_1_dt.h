...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . kk3uztsshn
) , 0 , 0 , 2 } , { ( char_T * ) ( & rtDW . ob3qkqxv3r ) , 0 , 0 , 1 } , { (
char_T * ) ( & rtDW . bzwx0etjsl ) , 15 , 0 , 1 } , { ( char_T * ) ( & rtDW .
f3igkwy2zl . LoggedData ) , 11 , 0 , 2 } , { ( char_T * ) ( & rtDW .
m1q5s1fwbj ) , 6 , 0 , 2 } } ; static DataTypeTransitionTable rtBTransTable =
{ 5U , rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { {
( char_T * ) ( & rtP . Integrator_IC ) , 0 , 0 , 5 } } ; static
